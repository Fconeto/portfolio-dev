export const translations = {
  pt: {
    ...
    projectAppMobileDesc: 'Aplicativo híbrido com React Native e Firebase.',
    projectWebSystemTitle: 'Sistema Web',
    projectWebSystemDesc: 'Plataforma corporativa com autenticação e gerenciamento.',
    projectBlogTitle: 'Blog Pessoal',
    projectBlogDesc: 'Plataforma de conteúdo com Next.js e Markdown.',
  ...
  en: {
    ...
    projectAppMobileDesc: 'Hybrid application with React Native and Firebase.',
    projectWebSystemTitle: 'Web System',
    projectWebSystemDesc: 'Corporate platform with authentication and management.',
    projectBlogTitle: 'Personal Blog',
    projectBlogDesc: 'Content platform with Next.js and Markdown.',
