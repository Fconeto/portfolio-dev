export const translations = {
  pt: {
    ...
    introJobTitle1: "Desenvolvedor",
    introJobTitle2: "Full Stack",
    introTagline: "Criando experiências digitais modernas e funcionais com tecnologias de ponta.",
    introCta: "Conhecer meu trabalho",
    // About
    ...
    projectSammyTitle: 'Sammy Gelados',
    projectSammyDesc: 'Desenvolvimento de um site institucional moderno para a Sammy Gelados, com foco na apresentação dos produtos, fortalecimento da presença digital e facilidade de contato com os clientes.',
    projectSammyAlt: 'Imagem da página inicial do site da Sammy Gelados',
    ...
    projectUnifocoAlt: 'Imagem da página de login do Unifoco',
    projectUnifocoExplain: 'O projeto Unifoco endemias não está acessível ao público.',
    projectLink: "Ver projeto",
    projectAttosTitle: 'Attos Consultoria',
    projectAttosDesc: 'Desenvolvimento do site institucional para Attos Consultoria, empresa focada em supply chain e logística.',
    projectAttosAlt: 'Imagem da página inicial do site da Attos Consultoria',
    projectPrataLoversTitle: 'Prata Lovers',
    projectPrataLoversDesc: 'Criação do e-commerce Prata Lovers, especializado em joias de prata personalizadas.',
    projectPrataLoversAlt: 'Imagem da página inicial do site Prata Lovers',
    // Contact
  ...
  en: {
    ...
    // Intro
    headerName: "Francisco Linhares",
    introJobTitle1: "Full Stack",
    introJobTitle2: "Developer",
    introTagline: "Creating modern and functional digital experiences with cutting-edge technologies.",
    introCta: "Learn about my work",
    // About
    aboutTitle: "About Me",
    ...
    projectSammyTitle: 'Sammy Gelados',
    projectSammyDesc: 'Development of a modern institutional website for Sammy Gelados, focused on showcasing its products, strengthening its online presence, and making it easier for customers to get in touch.',
    projectSammyAlt: 'Image of the Sammy Gelados website home page',
    projectUnifocoTitle: 'Unifoco endemias',
    ...
    projectUnifocoAlt: 'Image of the Unifoco login page',
    projectUnifocoExplain: 'The Unifoco endemias project is not publicly accessible.',
    projectLink: "View project",
    projectAttosTitle: 'Attos Consultoria',
    projectAttosDesc: 'Development of the institutional website for Attos Consultoria, a company focused on supply chain and logistics.',
    projectAttosAlt: 'Image of the home page of the Attos Consultoria website',
    projectPrataLoversTitle: 'Prata Lovers',
    projectPrataLoversDesc: 'Creation of the Prata Lovers e-commerce, specialized in personalized silver jewelry.',
    projectPrataLoversAlt: 'Image of the home page of the Prata Lovers website',
    // Contact
